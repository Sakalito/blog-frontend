<template>
  <header>
    <div
      class="sticky top-0 z-40 flex-none w-full transition-colors duration-500 backdrop-blur lg:z-50 lg:border-b lg:border-slate-900/10 bg-white/95 supports-backdrop-blur:bg-white/60"
    >
      <div
        class="px-4 py-4 mx-auto border-b max-w-8xl border-slate-900/10 lg:px-8 lg:border-0 dark:border-slate-300/10"
      >
        <a
          href=""
        ...
        >
          <img
            src="../../assets/logo_tailwindcss.png"
            class="w-auto h-5"
          />
        </a>
        <div class="flex">
